...
async function loadGameDetail(id) {
    ...
    try {
        ...
        const starsHtml = '<i class="icon-star-filled"></i>'.repeat(filledStars) + '<i class="icon-star-empty"></i>'.repeat(5 - filledStars);
        ...
        const wishBtnText = isWishlisted ? '<i class="icon-heart-filled"></i>Wishlisted' : '<i class="icon-heart"></i> Add to Wishlist';
            ...
            ? reviews.map(r => `
                <div style="background:var(--surface-secondary); border-radius:12px; padding:16px; margin-bottom:12px;">
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:8px;">
                        <strong style="color:var(--text-primary);"><i class="icon-user"></i> ${r.ReviewerName}</strong>
                        <span style="color:var(--accent-primary);">${'<i class="icon-star-filled"></i>'.repeat(r.Rating)}${'<i class="icon-star-empty"></i>'.repeat(5 - r.Rating)}</span>
                    </div>
                    ...
                    <form id="review-form" style="max-width:500px;">
                        ...
                        <div style="margin-bottom:12px;">
                            ...
                            <select id="review-rating" class="form-control" required>
                                ...
                                <option value="5"><i class="icon-star-filled"></i><i class="icon-star-filled"></i><i class="icon-star-filled"></i><i class="icon-star-filled"></i><i class="icon-star-filled"></i> (5)</option>
                                <option value="4"><i class="icon-star-filled"></i><i class="icon-star-filled"></i><i class="icon-star-filled"></i><i class="icon-star-filled"></i><i class="icon-star-empty"></i> (4)</option>
                                <option value="3"><i class="icon-star-filled"></i><i class="icon-star-filled"></i><i class="icon-star-filled"></i><i class="icon-star-empty"></i><i class="icon-star-empty"></i> (3)</option>
                                <option value="2"><i class="icon-star-filled"></i><i class="icon-star-filled"></i><i class="icon-star-empty"></i><i class="icon-star-empty"></i><i class="icon-star-empty"></i> (2)</option>
                                <option value="1"><i class="icon-star-filled"></i><i class="icon-star-empty"></i><i class="icon-star-empty"></i><i class="icon-star-empty"></i><i class="icon-star-empty"></i> (1)</option>
                            </select>
                        </div>
                        <div style="margin-bottom:12px;">
