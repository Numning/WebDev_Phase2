    ...
    try {
        ...
        container.innerHTML = games.map(game => {
            ...
            <div class="card" style="position:relative;">
                <button class="btn-danger" style="position:absolute; top:8px; right:8px; z-index:10; border-radius:50%; width:30px; height:30px; padding:0; display:flex; align-items:center; justify-content:center; border:none; cursor:pointer;" onclick="removeWishlist(${game.GameID})"><i class="icon-x"></i></button>
