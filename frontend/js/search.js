...
async function loadGames() {
    ...
    try {
        ...
        if (games.length === 0) {
            grid.innerHTML = '<div class="empty-state"><div class="icon">🔍</div><p>No games match your search. Try different filters.</p></div>';
            return;
        }
        ...
        console.error(err);
        grid.innerHTML = '<div class="empty-state"><div class="icon">⚠️</div><p>Failed to load games. Please ensure the backend server is running on port 3000.</p></div>';
