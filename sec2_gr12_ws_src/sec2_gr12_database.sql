...
('Lisa', 'Park', 26, '321 Dev Lane, Bangkok', 'lisa@gamehub.com', 'Manager'),
('Tom', 'Wilson', 32, '654 Code St, Pattaya', 'tom@gamehub.com', 'Manager'),
('Emma', 'Davis', 29, '987 Script Ave, Chiang Rai', 'emma@gamehub.com', 'Manager'),
('James', 'Kim', 31, '111 Api Blvd, Hat Yai', 'james@gamehub.com', 'Manager'),
('Sophia', 'Lee', 27, '222 Query Rd, Nonthaburi', 'sophia@gamehub.com', 'Moderator'),
('Oliver', 'Brown', 34, '333 Index Way, Samut Prakan', 'oliver@gamehub.com', 'Moderator'),
('Isabella', 'Garcia',  25, '444 Cache St, Rayong', 'isabella@gamehub.com', 'Moderator'),
('Lucas', 'Martinez', 28, '555 Node Way, Bangkok', 'lucas@gamehub.com', 'Manager'),
('Mia', 'Johnson', 30, '666 React Blvd, Chiang Mai', 'mia@gamehub.com', 'Manager'),
('Noah', 'Williams', 26, '777 Vue St, Phuket', 'noah@gamehub.com', 'Moderator'),
('Olivia', 'Taylor', 33, '888 Angular Ave, Hua Hin', 'olivia@gamehub.com', 'Moderator'),
('Ethan', 'Anderson',29, '999 Express Rd, Nakhon', 'ethan@gamehub.com', 'Content Manager');
...
('Elden Ring', 1790.00, 'Sale', 30, 'Explore a massive fantasy world with challenging combat, dangerous bosses, and hidden secrets.', '2022-02-25', '/images/games/Elden Ring/front.jpg', '["/images/games/Elden Ring/detail_1.jpg","/images/games/Elden Ring/detail_2.jpg","/images/games/Elden Ring/detail_3.jpg","/images/games/Elden Ring/detail_4.jpg"]'),
('Red Dead Redemption 2', 1599.00, 'Sale', 30, 'Story-driven western adventure with realistic open-world exploration, missions, and memorable characters.', '2018-10-26', '/images/games/Red Dead Redemption 2/front.jpg', '["/images/games/Red Dead Redemption 2/detail_1.jpg","/images/games/Red Dead Redemption 2/detail_2.jpg","/images/games/Red Dead Redemption 2/detail_3.jpg","/images/games/Red Dead Redemption 2/detail_4.jpg"]'),
('Baldur''s Gate 3', 1799.00, 'Regular', 0, 'Party-based RPG where your choices shape the story and battles use tactical turn-based combat.', '2023-08-03', '/images/games/Baldur_s Gate 3/front.jpg', '["/images/games/Baldur_s Gate 3/detail_1.jpg","/images/games/Baldur_s Gate 3/detail_2.jpg","/images/games/Baldur_s Gate 3/detail_3.jpg","/images/games/Baldur_s Gate 3/detail_4.jpg"]'),
('Stardew Valley', 315.00, 'Regular', 0, 'Build a farm, grow crops, explore caves, fish, and make friends in a peaceful town.', '2016-02-26', '/images/games/Stardew Valley/front.jpg', '["/images/games/Stardew Valley/detail_1.jpg","/images/games/Stardew Valley/detail_2.jpg","/images/games/Stardew Valley/detail_3.jpg","/images/games/Stardew Valley/detail_4.jpg"]'),
('Terraria', 220.00, 'Regular', 0, 'Dig, build, craft, and fight powerful bosses in a huge 2D sandbox world.', '2011-05-16', '/images/games/Terraria/front.jpg', '["/images/games/Terraria/detail_1.jpg","/images/games/Terraria/detail_2.jpg","/images/games/Terraria/detail_3.jpg","/images/games/Terraria/detail_4.jpg"]');
-- GameGenre mappings (GameID -> GenreID)
...
-- Reviews (41 reviews across 24 games)
...
-- Wishlist seed data (14 entries) — session-based with UserID for logged-in users
INSERT INTO Wishlist (GameID, SessionID, UserID) VALUES
(2,  'sess-demo-0001', 1),
(3,  'sess-demo-0001', 1),
(5,  'sess-demo-0002', 2),
(8,  'sess-demo-0002', 2),
...
-- Cart seed data (13 entries, max 1 copy per game per session)
INSERT INTO Cart (GameID, SessionID, UserID, Quantity) VALUES
...
(2,'sess-user-0001',1,1),
(11,'sess-user-0002',2,1),
(18,'sess-user-0002',2,1),
(20,'sess-user-0003',3,1),
(22,'sess-user-0004',4,1);
